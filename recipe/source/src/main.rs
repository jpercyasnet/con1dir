    ...
    fn new() -> (Self, iced::Task<Message>) {
        (  MainX {
                ...
                scrol_value: " No directory selected \n \
                            ".to_string(),
                scrolheight: 100.0,
                hhmmss_value: "-00:00:00:00:00:00".to_string(),
            ...
            Message::PageRadioSelected(xchoice) => {
                ...
                match xchoice {
                    ...
                    PageChoice::OD => {
                             ...
                             self.dirset = 2;
                             let (errcd, errstr, newdir, listitems) = get_dirlistc(self.outdir_value.clone(), self.fdgetdiritems.clone());
                             if errcd == 0 {
                                 self.fdfiles.clear();                         
                                 self.fdoutdir_value = newdir.to_string();
                                 let listitemlen = listitems.len();
...
// main program
                PageChoice::MAIN => {
                    secshow = secshow.push(container(row![scrollable(
                                                            column![
                    ...
                    secshow = secshow.push(container(row![text("date mod value (-YY:MM:DD:hh:mm:ss): ").size(15),
                         text_input("No input....", &self.hhmmss_value)
                            .on_input(Message::HhmmssChanged).padding(5).size(15),
                         text("     Length of File Description: "),
                         text_input("No input....", &self.size_value).on_input(Message::SizeChanged).padding(5).size(15),
                           ].align_y(Alignment::Center).spacing(5).padding(5),
                         ));
                    secshow = secshow.push(container(row![
                                              uc, text(&self.outdir_value).size(15)
                                              ].align_y(Alignment::Center).spacing(5).padding(5),
                         ));
                    secshow = secshow.push(container(row![scrollable(
                                                            column![
